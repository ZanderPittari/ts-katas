...
var beer_song_1 = require("./beer-song");
(0, vitest_1.describe)('BeerSong', function () {
    var song;
    (0, vitest_1.beforeEach)(function () {
        song = new beer_song_1.BeerSong();
    });
    ...
    (0, vitest_1.it)('prints another arbitrary verse', function () {
        var expected = '42 bottles of beer on the wall, 42 bottles of beer.\nTake one down and pass it around, 41 bottles of beer on the wall.\n';
        var actual = song.verse(42);
        (0, vitest_1.expect)(actual).toEqual(expected);
    });
